<?php
  ...
  */
  ...
  $strCourseNumber = "GSP 689";
  $strCourseSemester = "Spring 2019";
  $strLectureNumber = "1";
  $strLectureTitle = "Practicum Defense Presentation";
  $strDate = "Week 5";
  $strTest = "Capstone";
  $strPNGpath = "DefensePresentation";
  $strPNGpattern = "Slide";
  $strPNGextension = ".png";
          ...
          <?php            
            ...
            {                                                                                                                                               
              if ($dh = opendir($strPNGpath))                                                                                                                     
              {
                ...
                {
                  if (strtolower(substr($file, -4)) == strtolower($strPNGextension))
                  {
